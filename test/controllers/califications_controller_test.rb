...
class CalificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calification" do
    assert_difference("Calification.count") do
      post califications_url, params: { calification: { advice: @calification.advice, points: @calification.points } }
    end
  ...
  test "should update calification" do
    patch calification_url(@calification), params: { calification: { advice: @calification.advice, points: @calification.points } }
